...
public class CreateMapValuesOnlyOutput {
public static void main(String[] args) {
	...
	mp.put(50, "pspl");
	mp.put(40, "Hadoop");
    System.out.println("The Hash Map values(only values) is");
	...
	mp1.put(50, 50);
	mp1.put(40, 40);
    System.out.println("The LinkedHash Map values(only values) is");
	...
	mp2.put("*",50);
	mp2.put("(",40);
    System.out.println("The TreeHash Map values(only values) is");
    ...
    mp3.put("subash", "jira");
    System.out.println("The HashTable Values(only values) is");
    for(int i=0;i<mp3.size();i++) {
}
    System.out.println(mp3.values());
}
}
